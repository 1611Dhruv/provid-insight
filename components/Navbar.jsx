    ...
    <div className="navbar">
      ...
      {user ? (
        <div className="navbar-center flex-none">
          ...
          <Link className="btn btn-ghost mx-4 normal-case text-med" href="/summary">
            Summary
          </Link>
      ...
      <div className="navbar-end">
        {user ? (
          <Link className="btn btn-ghost mx-4 normal-case text-med" href={"/api/auth/logout"}>
            Logout
          </Link>
        ) : (
          <Link className="btn btn-ghost mx-4 normal-case text-med" href={"/api/auth/login"}>
            Login
          </Link>
        )}
      </div>
